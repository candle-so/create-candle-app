  ...
  return [
    {
      ...
      cell: ({ row }: any) => {
        ...
        return buyers.map((buyer: any) => (
          <div key={buyer.id} className="inline-block cursor-pointer" onClick={() => onClick(row.original)}>
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        return sellers.map((seller: any) => (
          <div key={seller.id} className="inline-block cursor-pointer" onClick={() => onClick(row.original)}>
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        if (status === "request") status = "request sent";
